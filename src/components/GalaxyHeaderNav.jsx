...
import { listEnabledProposals, DEFAULT_PROPOSAL_ID, proposalGithubUrl, getProposalById } from "../config/proposals";

function proposalStatusLabel(proposal) {
  if (!proposal) return "";
  if (proposal.id === DEFAULT_PROPOSAL_ID) return "Final snapshot";
