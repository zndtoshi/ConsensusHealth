...
export const PROPOSAL_THEMES: Record<ProposalThemeKey, ProposalVisualTheme> = {
  "nebula-red": {
    ...
    nebulaFrom: "rgba(127, 29, 29, 0.16)",
    nebulaTo: "rgba(15, 23, 42, 0.55)",
  ...
  "nebula-cyan": {
    ...
    nebulaFrom: "rgba(8, 145, 178, 0.14)",
    nebulaTo: "rgba(15, 23, 42, 0.55)",
  ...
  "nebula-violet": {
    ...
    nebulaFrom: "rgba(91, 33, 182, 0.14)",
    nebulaTo: "rgba(15, 23, 42, 0.55)",
  ...
  "nebula-yellow": {
    accent: "#e8d48b",
    accentSoft: "rgba(232, 212, 139, 0.18)",
    nebulaFrom: "rgba(133, 98, 18, 0.14)",
    nebulaTo: "rgba(15, 23, 42, 0.55)",
